...
},{"./showBotSubmittedChat":10}],9:[function(require,module,exports){
'use strict';
...
var _showInProgressChat = require("./showInProgressChat");
...
var showBotSubmittedChat = exports.showBotSubmittedChat = function showBotSubmittedChat(chatResponse) {
    ...
    setTimeout(function () {
        (0, _showInProgressChat.showInProgressChat)();
...
},{"./showInProgressChat":11}],11:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var showInProgressChat = exports.showInProgressChat = function showInProgressChat(elementChatInput) {
