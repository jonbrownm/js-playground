...
var _cmpImageInterchange = require('./components/cmpImageInterchange');
...
(0, _cmpImageInterchange.cmpImageInterchange)();

},{"./components/cmpCardSelector":2,"./components/cmpCategoryArticleSelector":7,"./components/cmpCountrySearch":12,"./components/cmpImageInterchange":17}],2:[function(require,module,exports){
'use strict';
...
var componentImageInterchange = document.querySelector("[data-component-name='cmpImageInterchange']");

var cmpImageInterchange = exports.cmpImageInterchange = function cmpImageInterchange() {
	...
	if (componentImageInterchange) {
		...
		var config = {
		    ...
		    elements = [],
		    buildBackgroundImageUrl = function buildBackgroundImageUrl(backgroundImageUrl, interchangeUrl) {

			return "url('" + backgroundImageUrl + interchangeUrl + "')";
		},
		    extractBackgroundImageUrl = function extractBackgroundImageUrl(element) {

			return element.style.backgroundImage.replace('url("', '').replace('")', '');
		},
		    interchangeBackgroundCondition = function interchangeBackgroundCondition(element) {
		    ...
		    interchangeBackgroundImage = function interchangeBackgroundImage(element, isProgressive) {
			if (isProgressive) {
		    ...
		    interchangeImageCondition = function interchangeImageCondition(img) {
			if (viewportWidth > config.breakPoint) {
		    ...
		    interchangeImgSrc = function interchangeImgSrc(img, isProgressive) {
			if (isProgressive) {
		    ...
		    checkElementTag = function checkElementTag(element) {
