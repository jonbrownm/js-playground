...
var _showInProgressChat = require('./cmpChatInterface/showInProgressChat');
...
var cmpChatInterface = exports.cmpChatInterface = function cmpChatInterface() {
	...
	if (componentChatInterface) {
		(0, _showInProgressChat.showInProgressChat)(elementChatInput);
		(0, _getSubmittedChat.getSubmittedChat)(elementChatInput);
	}
};

},{"./cmpChatInterface/getSubmittedChat":8,"./cmpChatInterface/showInProgressChat":10}],8:[function(require,module,exports){
'use strict';
...
var getSubmittedChat = exports.getSubmittedChat = function getSubmittedChat(elementChatInput) {
...
},{"./showSubmittedChat":11}],9:[function(require,module,exports){
"use strict";
