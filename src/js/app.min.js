...
var _showBotSubmittedChat = require('./cmpChatInterface/showBotSubmittedChat');

var _getUserSubmittedChat = require('./cmpChatInterface/getUserSubmittedChat');
...
var cmpChatInterface = exports.cmpChatInterface = function cmpChatInterface() {
	...
	if (componentChatInterface) {
		(0, _showBotSubmittedChat.showBotSubmittedChat)("Welcome ...");
		(0, _getUserSubmittedChat.getUserSubmittedChat)(elementChatInput);
	}
};

},{"./cmpChatInterface/getUserSubmittedChat":9,"./cmpChatInterface/showBotSubmittedChat":11}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.getBotSubmittedChat = undefined;

var _showBotSubmittedChat = require("./showBotSubmittedChat");

var getBotSubmittedChat = exports.getBotSubmittedChat = function getBotSubmittedChat() {

    var chatResponseIndex = Math.floor(Math.random() * 2 + 1),
        chatResponse,
        chatResponses = ["Sorry, I don't understand.", "Hello, is anyone there?", "Ok, I see what you mean."];

    chatResponse = chatResponses[chatResponseIndex];

    (0, _showBotSubmittedChat.showBotSubmittedChat)(chatResponse);
};

},{"./showBotSubmittedChat":11}],9:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.getUserSubmittedChat = undefined;

var _showUserSubmittedChat = require('./showUserSubmittedChat');

var getUserSubmittedChat = exports.getUserSubmittedChat = function getUserSubmittedChat(elementChatInput) {
	...
	elementChatInput.addEventListener('keyup', function (e) {
		...
		if (e.keyCode === 13) {
			...
			submittedChat.value = "";
			(0, _showUserSubmittedChat.showUserSubmittedChat)(submittedChatMessage);
		}
	});
};

},{"./showUserSubmittedChat":12}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var showBotInProgressChat = exports.showBotInProgressChat = function showBotInProgressChat(elementChatInput) {
...
exports.showBotSubmittedChat = undefined;

var _showBotInProgressChat = require("./showBotInProgressChat");

var showBotSubmittedChat = exports.showBotSubmittedChat = function showBotSubmittedChat(chatResponse) {
    ...
    (0, _showBotInProgressChat.showBotInProgressChat)();
...
},{"./showBotInProgressChat":10}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showUserSubmittedChat = undefined;

var _getBotSubmittedChat = require("./getBotSubmittedChat");

var showUserSubmittedChat = exports.showUserSubmittedChat = function showUserSubmittedChat(submittedChat) {
  ...
  (0, _getBotSubmittedChat.getBotSubmittedChat)();
};

},{"./getBotSubmittedChat":8}]},{},[1]);
