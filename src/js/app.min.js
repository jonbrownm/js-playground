...
var cmpCountrySearch = exports.cmpCountrySearch = function cmpCountrySearch() {
	...
	elementSearchInput.addEventListener('keyup', function () {
		...
		console.log((0, _getUserInput.getUserInput)(elementSearchInput));

		(0, _returnCountryList.returnCountryList)();
	});
};
...
var returnCountryList = exports.returnCountryList = function returnCountryList() {
