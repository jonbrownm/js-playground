...
var getAllSelectedCategory = exports.getAllSelectedCategory = function getAllSelectedCategory(elementArticleSelectorItem, currentViewArticleList) {
...
var getSelectedCategory = exports.getSelectedCategory = function getSelectedCategory(elementArticleSelectorItem, elementArticleItems) {
	...
	for (var i = 0; i < elementArticleSelectorItem.length; i++) {
		...
		elementArticleSelectorItem[i].addEventListener('click', function (e) {
			...
			(0, _showSelectedCategory.showSelectedCategory)(currentSelectedCategory, elementArticleItems);
		});
	}
};
...
var showAllSelectedCategory = exports.showAllSelectedCategory = function showAllSelectedCategory(currentViewArticleList) {
